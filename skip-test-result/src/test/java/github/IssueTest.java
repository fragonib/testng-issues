...
public class IssueTest extends SimpleBaseTest {
    ...
    private static Map<String, String> expected() {
        ...
        expected.put(ChildClassSample.class.getSimpleName() + "-childClassBeforeMethod", ChildClassSample.class.getName() + ".childClassBeforeMethod()");
        expected.put(ChildClassSample.class.getSimpleName() + "-parentClassBeforeMethod", ChildClassSample.class.getName() + ".parentClassBeforeMethod()");
        return expected;
    }
